...
import { Shield, Landmark, BarChart3, Bell, Wallet, LogOut, Search, Flame, Sparkles, Trophy, Bitcoin, TrendingUp, Globe, Monitor, Theater, Earth, Microscope } from 'lucide-react';
import './App.css';

// Map string icon names from API to Lucide components
export const IconMap = {
  Flame, Sparkles, Landmark, Trophy, Bitcoin, TrendingUp,
    ...
    <div className="app">
      <header className="header">
        ...
        <div className="header-right">
          ...
          <button className="hdr-btn" onClick={() => setShowCashier(true)}>
            <Landmark size={16} />
            <span className="hdr-btn-label">Cashier</span>
          </button>
